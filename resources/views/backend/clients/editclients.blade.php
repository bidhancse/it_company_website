    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card card-shadow mb-4">
          ...
          <div class="card-body">
            <form method="POST" action="{{ url('clientsupdate/'.$Data->id) }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Company Name" style="border-radius: 0px;" name="company_name" value="{{ $Data->company_name }}">
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Website Url" style="border-radius: 0px;" name="website_url" value="{{ $Data->website_url }}">
                  </div>
                </div>
              </div> 
